...
| Capability | Rust (`fastcore`) | Python (`navis-fastcore`) | R (`nat.fastcore`) |
|---|---|---|---|
| Connected components of a triangle mesh, by vertex, face or manifold edge | `mesh::mesh_connected_components`, `mesh::mesh_face_components` | `mesh_connected_components` | `mesh_connected_components` |
